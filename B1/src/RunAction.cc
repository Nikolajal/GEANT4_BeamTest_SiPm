...
: G4UserRunAction() { 
  ...
  analysisManager->CreateH2("Chamber1_XY","Drift Chamber 1 X vs Y", 28*50, -16., 12., 14*50, -9., 5.); 
...
{ 
  ...
  // 
  const G4double milligray = 100.e-3*gray;
  const G4double microgray = 100.e-6*gray;
  const G4double nanogray  = 100.e-9*gray;  
  const G4double picogray  = 100.e-12*gray;
